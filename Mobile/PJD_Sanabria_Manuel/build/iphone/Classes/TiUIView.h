...
/**
 Base class for all PJD_Sanabria_Manuel views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the PJD_Sanabria_Manuel view hierarchy (such as wrapped iOS UIViews) was touched.
