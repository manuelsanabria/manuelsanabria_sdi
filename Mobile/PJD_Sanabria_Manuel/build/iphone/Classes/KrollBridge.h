...
@interface PJD_Sanabria_ManuelObject : KrollCoverageObject {
#else
@interface PJD_Sanabria_ManuelObject : KrollObject {
#endif
@private
...
extern NSString * PJD_Sanabria_Manuel$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	PJD_Sanabria_ManuelObject *_pjd_sanabria_manuel;
    KrollObject* console;
	BOOL shutdown;
