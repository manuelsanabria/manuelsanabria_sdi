...
//Rare exceptions to indicate a bug in the _pjd_sanabria_manuel code (Eg, function that a subclass should have implemented)
...
/**
 The base class for PJD_Sanabria_Manuel proxies.
 */
