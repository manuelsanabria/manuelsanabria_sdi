 ...
 * to send analytic data that can be viewed on the PJD_Sanabria_Manuel Dashboard.
 *
 * For information on getting started with PJD_Sanabria_Manuel Platform Services,
