...
//@interface PJD_Sanabria_ManuelObject : NSObject
//@end

@interface PJD_Sanabria_ManuelObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PJD_Sanabria_ManuelObject class]])
		{
			for (NSString *key in [[(PJD_Sanabria_ManuelObject*)o modules] allKeys])
			{
