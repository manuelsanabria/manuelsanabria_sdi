...
// in simulator we redefine to format for PJD_Sanabria_Manuel Developer console
...
{\
	NSString * exceptionName = [@"org.pjd_sanabria_manuel." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.pjd_sanabria_manuel";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPJD_Sanabria_ManuelNativeItemNone = -1, 
	UIPJD_Sanabria_ManuelNativeItemSpinner = -2,
	UIPJD_Sanabria_ManuelNativeItemProgressBar = -3,
	
	UIPJD_Sanabria_ManuelNativeItemSlider = -4,
	UIPJD_Sanabria_ManuelNativeItemSwitch = -5,
	UIPJD_Sanabria_ManuelNativeItemMultiButton = -6,
	UIPJD_Sanabria_ManuelNativeItemSegmented = -7,
	
	UIPJD_Sanabria_ManuelNativeItemTextView = -8,
	UIPJD_Sanabria_ManuelNativeItemTextField = -9,
	UIPJD_Sanabria_ManuelNativeItemSearchBar = -10,
	
	UIPJD_Sanabria_ManuelNativeItemPicker = -11,
	UIPJD_Sanabria_ManuelNativeItemDatePicker = -12,
	
	UIPJD_Sanabria_ManuelNativeItemInfoLight = -13,
	UIPJD_Sanabria_ManuelNativeItemInfoDark = -14,
	
	UIPJD_Sanabria_ManuelNativeItemDisclosure = -15,
	
	UIPJD_Sanabria_ManuelNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all PJD_Sanabria_Manuel instances of
