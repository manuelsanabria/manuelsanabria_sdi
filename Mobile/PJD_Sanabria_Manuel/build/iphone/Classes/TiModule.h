...
/**
 The base class for all PJD_Sanabria_Manuel modules
 */
...
/**
 PJD_Sanabria_Manuel Platform calls this method on startup.
 */
-(void)startup;

/**
 PJD_Sanabria_Manuel Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 PJD_Sanabria_Manuel Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 PJD_Sanabria_Manuel Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 PJD_Sanabria_Manuel Platform calls this method on resume.
 @param sender The sender of the event.
 */
